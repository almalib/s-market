...
import { MarketMethodInterface } from "../../../../../../../../../../index";
...
export class SCntMarketOrderingMethod implements ComponentInterface {
   ...
   */
  @Prop() method: MarketMethodInterface;
    ...
    return (
      <div class={this.addOrRemoveClassState ? "active" : ""}>
        <div class="ordering-panel">
          <div
            class="panel-header"
            onClick={() => this.addClassActiveHandler({ step: this.method.id })}
          >
          ...
          <div class="ordering-panel-hide">
            <div class="panel-content">
              <div class="shipping-method">
                ...
                <button
                  onClick={() =>
                    this.removeClassActiveHandler({ step: this.method.id })
                  }
                >
                  {this.method.btn}
                </button>
