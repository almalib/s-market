...
@Component({
  tag: "s-cnt-market-cart-products",
  styleUrl: "s-cnt-market-cart-products.css",
  shadow: false,
  scoped: true,
})
export class SCntMarketCartProducts implements ComponentInterface {
  /**
   * Продукты из корзины
   * */
  @Prop() MarketCartProductsState: MarketCartProductsInterface[] = [];
   ...
   *
   * */
  @Event() clickOnByProducts: EventEmitter<void>;
        ...
        <div class="new-cart">
          ...
          <div class="message-box">
            <button class="btn-buy"
              onClick={()=> this.clickOnByProductsHandler()}
            >
              Сделать заказ
   ...
   * */
  public clickOnByProductsHandler() {
