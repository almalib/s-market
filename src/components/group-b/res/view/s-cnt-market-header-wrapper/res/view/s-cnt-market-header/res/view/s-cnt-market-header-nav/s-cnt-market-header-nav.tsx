...
export class SCntMarketHeaderNav implements ComponentInterface {
   ...
   *
   */
  @Event() clickOnWishlist: EventEmitter;

  /**
   *
   */
  @Event() clickOnOrders: EventEmitter;

  /**
   *
   */
  @Event() clickOnByProducts: EventEmitter;
        ...
        <div class="row">
          <div class="col">
            <div class="nav-wrapper">
              ...
              <div
                class="user-wish-list"
                onClick={() => this.clickOnWishlistHandler()}
              >
                <a>
              ...
              {this.login ? (
                <div class="user-orders"
                  onClick={()=> this.clickOnOrdersHandler()}
                >
                  <a>
