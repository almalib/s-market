  ...
  render() {
    return (
      <form class="login-form">
        ...
        <button class="login-btn" ref={(el) => this.logInBtn = el} type='button' onClick={()=> this.inputValidationOnClick()}>
          {this.login.logIn}
        </button>
        ...
        <div class="login-through-wrapper">
          <button class="login-through-bankId" type='button'>
