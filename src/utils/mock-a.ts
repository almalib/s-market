...
export const adminToolbarCategory = {
  wrapTitle: 'Категории',
  toolbarCategoryHead: {
    toolbarHeadBtn: [
      {
        ...
        btnText: ' Добавить корневую категорию',
        btnIcon:  "fas fa-plus",
        btnDisabled: false,
      ...
      {
        id: 3,
        btnText: ' Удалить категорию',
        btnIcon:  "fas fa-minus",
        btnDisabled: true,
        btnClass: 'default',
      },
    ]
  ...
  toolbarCategorySide: {
    ...
    sidebarSubtitle: 'Сортируйте элементы перетаскиванием',
    sidebarViewStart: 'Свернуть все',
    sidebarViewCenter: '|',
    sidebarViewEnd: 'Развернуть все',
    sidebarCategoryItems: [
      {
        id: 1,
        category: 'Домашняя страница магазина',
        quantity: 9,
      },
    ],
  },
  toolbarEditor: {
    title: 'Домашняя страница магазина',
    preview: 'Предпросмотр категории',
    mainTab: 'Основное',
    productsTab: 'Товары в категории',
    editorPage: {
    ...
    categoryProducts: {
      ...
      snapBtnText: 'Привязать товары',
      deleteBtnText: 'Удалить все',
      addBtnText: 'Создать товар',
      categoryProductsList: {
        vendorCodeTitle: 'Артикул',
        productNameTitle: 'Название',
        productList: [
          {
            id: 1,
            vendorCode: '0002',
            productName: 'ОБРАЗЕЦ. Шорты',
      ...
      productsListFooter: {
        pagingBarText: 'Страниц:',
        btnLeftIcon: 'fas fa-angle-left',
        btnRightIcon: 'fas fa-angle-right',
        productQuantityTitle: 'Элементов:',
        productQuantityOnPage: '1-9',
        productQuantity: ' 9',
        quantityProductTitle: 'На странице:',
        quantityProduct: [
          {
            id: 1,
            quantity: 100,
    ...
    addRootCategory: {
      component: 'addRootCategory',
      newNameTitle: 'Название',
      newStatusTitle: 'Статус',
      statusSwitcherIconDisabled: 'fas fa-circle',
      statusSwitcherIconIncluded: 'fas fa-check',
      statusSwitcherChoiceIncluded: 'Включить',
      statusSwitcherChoiceDisabled: 'Отключить',
      statusSwitcherDisabled: 'Отключено',
      statusSwitcherIncluded: 'Включено',
      newImgTitle: 'Изображение категории',
      newImgLoadIcon: 'fas fa-gift',
      imgLoadTitle: 'Добавить/изменить изображение',
      editorPage: {
        title: 'Описание',
        editorBox: [
          {
  ...
  toolbarFooter: {
    shopIdTitle: 'ID магазина:',
    shopId: '36132004',
    mobileAppLink: 'Мобильное приложение',
    copyright: '© 2009–2020 Ecwid.com',
    footerMenu: [
      {
        id: 1,
        menuItem: 'Сайт Ecwid'
      ...
      {
        id: 3,
        menuItem: 'Условия предоставления сервиса'
      },
      {
        id: 4,
        menuItem: 'Политика конфиденциальности'
      },
    ],
    langSwitcherTitle: 'Language:',
    languageList: [
      {
        id: 1,
        language: 'Русский'
  ...
  productsPreviewModal: {
    productsSortTitle: 'Сортировка',
    productsSortIcon: 'fas fa-angle-down',
    sortSwitch: [
      {
        id: 1,
        switchItem: 'Наши рекомендации',
      },
      {
        id: 2,
        switchItem: 'Новинки',
      ...
      {
        id: 3,
        switchItem: 'Цена: от низкой к высокой',
      },
      {
        id: 4,
        switchItem: 'Цена: от высокой к низкой',
      },
      {
        id: 5,
        switchItem: 'Название: от А к Я',
      },
      {
        id: 6,
        switchItem: 'Название: от Я к А',
      },
    ],
    categoryProductPreview: [
      {
        id: 1,
        img: 'https://via.placeholder.com/310x310?text=products',
        name: 'ОБРАЗЕЦ. Шорты',
        price: '995.00₽',
      },
      {
