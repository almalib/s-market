...
import { AdminToolbarCategoryInterface, AdminToolbarHeadBtnInterface, CategoryEditorHomePage, footerContactColumnInterface, footerCopyrightRowInterface, footerDataInterface, footerItemsInterface, footerLinksPoliticsInterface, footerMenuInterface, MarketAppInterface, MarketCartProductsInterface, MarketChoiceInterface, MarketCitiesInterface, MarketCourierInterface, MarketDeliveryInterface, MarketFeaturedProductInterface, MarketGetProductInterface, MarketGetRecommendedInterface, MarketGetSpecificationInterface, MarketLeftMenuCatalogInterface as MarketLeftMenuCatalogInterface1, MarketLoginAndRegistrationInterface, MarketLoginInterface, MarketMethodInterface, MarketOfferInterface, MarketOrderingContactsInterface, MarketOrderingFinalInterface, MarketOrderingInterface, MarketOrderingModalsInterface, MarketOrderingPanelsInterface, MarketOrderingPaymentInterface, MarketOrderingReplacementsInterface, MarketOrderingSidebarPromoCardsInterface, MarketOrderingTimetableDateInterface, MarketOrderingTimetableInterface, MarketOrderingTimetableTimeInterface, MarketProductBlockInterface, MarketProductDataInterface, MarketProductListCardInterface, MarketProductListInterface, MarketProductModalInterface, MarketProductPageInterface, MarketProductsListAdminInterface, MarketProductsPageFilterInterface, MarketProductsSliderCardsInterface, MarketPromoSliderInterface, MarketRecentlyWatchedProductsInterface, MarketRecommendedBlockInterface, MarketRegistrationInterface, MarketRemindPasswordInterface, MarketSelectionInterface, MarketSelectShopsInterface as MarketSelectShopsInterface1, MarketSpecialistInterface, MarketSpecificationBlockInterface, MarketStatisticsInterface, MarketTopBarInterface, MarketTopBarModalDeliveryInterface, MarketTopBarModalInterface, MarketTopBarModalPickUpInterface, MarketUsersArrInterface, NavMenuItemInterface, ProductsCategoryListInterface, ProductsInCategoryFooterInterface, ToolbarAddRootCategoryInterface, ToolbarCategoryEditorInterface, ToolbarCategoryFooterInterface, ToolbarCategoryModalPreviewWindowInterface, ToolbarCategorySidebarInterface, ToolbarProductsInCategoryInterface, } from "./index";
...
export namespace Components {
    ...
    interface SCntMarketAdminToolbarCategory {
        "payload": AdminToolbarCategoryInterface;
    }
    interface SCntMarketAdminToolbarHeadBtn {
        "toolbarHead": AdminToolbarHeadBtnInterface;
    }
    ...
    interface SCntMarketCartProducts {
        /**
          * Продукты из корзины
         */
        "MarketCartProductsState": MarketCartProductsInterface[];
    }
    interface SCntMarketCategoryEditorHomePage {
        /**
    ...
    interface SCntMarketOrderingColumn {
        /**
          * Данные для панелей
         */
        "ordering": MarketOrderingInterface;
        /**
          * Данные для модалки
         */
        "orderingModals": MarketOrderingModalsInterface;
    }
    ...
    interface SCntMarketOrderingModalWindow {
        /**
          * Данные для модалки
         */
        "orderingModal": any;
    ...
    interface SCntMarketOrderingSidebarDropdown {
        /**
          * Данные для цен доставки и сборки
         */
        "deliveryInfo": any;
    }
    interface SCntMarketOrderingSidebarPromoCode {
        /**
          * Данные для модалки
         */
        "orderingModal": any;
    ...
    interface SCntMarketProductAdding {
    }
    interface SCntMarketProductAddingAttributes {
    }
    interface SCntMarketProductAddingMain {
    }
    interface SCntMarketProductAddingSidebar {
    }
    ...
    interface SCntMarketProductsListAdmin {
        "marketProductsListAdmin": MarketProductsListAdminInterface[];
    }
    ...
    interface SCntMarketProductsListWrapper {
    }
    ...
    interface SCntMarketTextRedactorBox {
        /**
          * данные компонента
         */
        "textRedactor": any;
    }
    interface SCntMarketToolbarAddRootCategory {
        "addRootCategory": ToolbarAddRootCategoryInterface;
    }
    interface SCntMarketToolbarCategoryEditor {
        /**
          * Стейт для переключения tabs
         */
        "selectedTabsState": any;
        "toolbarEditor": ToolbarCategoryEditorInterface;
    }
    interface SCntMarketToolbarCategoryFooter {
        "toolbarFooter": ToolbarCategoryFooterInterface;
    }
    interface SCntMarketToolbarCategoryModalPreviewWindow {
        "productsPreviewModal": ToolbarCategoryModalPreviewWindowInterface;
    }
    interface SCntMarketToolbarCategorySidebar {
        "toolbarSidebar": ToolbarCategorySidebarInterface;
    }
    interface SCntMarketToolbarProductsCategoryList {
        "productList": ProductsCategoryListInterface;
    }
    interface SCntMarketToolbarProductsInCategory {
        "categoryProducts": ToolbarProductsInCategoryInterface;
    }
    interface SCntMarketToolbarProductsInCategoryFooter {
...
declare global {
    ...
    interface HTMLSCntMarketAdminToolbarCategoryElement extends Components.SCntMarketAdminToolbarCategory, HTMLStencilElement {
    }
    var HTMLSCntMarketAdminToolbarCategoryElement: {
        prototype: HTMLSCntMarketAdminToolbarCategoryElement;
        new (): HTMLSCntMarketAdminToolbarCategoryElement;
    };
    interface HTMLSCntMarketAdminToolbarHeadBtnElement extends Components.SCntMarketAdminToolbarHeadBtn, HTMLStencilElement {
    }
    var HTMLSCntMarketAdminToolbarHeadBtnElement: {
        prototype: HTMLSCntMarketAdminToolbarHeadBtnElement;
        new (): HTMLSCntMarketAdminToolbarHeadBtnElement;
    };
    ...
    interface HTMLSCntMarketCartProductsElement extends Components.SCntMarketCartProducts, HTMLStencilElement {
    }
    var HTMLSCntMarketCartProductsElement: {
        prototype: HTMLSCntMarketCartProductsElement;
        new (): HTMLSCntMarketCartProductsElement;
    };
    interface HTMLSCntMarketCategoryEditorHomePageElement extends Components.SCntMarketCategoryEditorHomePage, HTMLStencilElement {
    }
    var HTMLSCntMarketCategoryEditorHomePageElement: {
        prototype: HTMLSCntMarketCategoryEditorHomePageElement;
        new (): HTMLSCntMarketCategoryEditorHomePageElement;
    };
    ...
    interface HTMLSCntMarketEmptyCartElement extends Components.SCntMarketEmptyCart, HTMLStencilElement {
    }
    var HTMLSCntMarketEmptyCartElement: {
        prototype: HTMLSCntMarketEmptyCartElement;
        new (): HTMLSCntMarketEmptyCartElement;
    };
    ...
    interface HTMLSCntMarketOrderingModalWindowElement extends Components.SCntMarketOrderingModalWindow, HTMLStencilElement {
    }
    var HTMLSCntMarketOrderingModalWindowElement: {
        prototype: HTMLSCntMarketOrderingModalWindowElement;
        new (): HTMLSCntMarketOrderingModalWindowElement;
    };
    ...
    interface HTMLSCntMarketOrderingSidebarDropdownElement extends Components.SCntMarketOrderingSidebarDropdown, HTMLStencilElement {
    }
    var HTMLSCntMarketOrderingSidebarDropdownElement: {
        prototype: HTMLSCntMarketOrderingSidebarDropdownElement;
        new (): HTMLSCntMarketOrderingSidebarDropdownElement;
    };
    interface HTMLSCntMarketOrderingSidebarPromoCodeElement extends Components.SCntMarketOrderingSidebarPromoCode, HTMLStencilElement {
    }
    var HTMLSCntMarketOrderingSidebarPromoCodeElement: {
        prototype: HTMLSCntMarketOrderingSidebarPromoCodeElement;
        new (): HTMLSCntMarketOrderingSidebarPromoCodeElement;
    };
    ...
    interface HTMLSCntMarketProductAddingElement extends Components.SCntMarketProductAdding, HTMLStencilElement {
    }
    var HTMLSCntMarketProductAddingElement: {
        prototype: HTMLSCntMarketProductAddingElement;
        new (): HTMLSCntMarketProductAddingElement;
    };
    interface HTMLSCntMarketProductAddingAttributesElement extends Components.SCntMarketProductAddingAttributes, HTMLStencilElement {
    }
    var HTMLSCntMarketProductAddingAttributesElement: {
        prototype: HTMLSCntMarketProductAddingAttributesElement;
        new (): HTMLSCntMarketProductAddingAttributesElement;
    };
    interface HTMLSCntMarketProductAddingMainElement extends Components.SCntMarketProductAddingMain, HTMLStencilElement {
    }
    var HTMLSCntMarketProductAddingMainElement: {
        prototype: HTMLSCntMarketProductAddingMainElement;
        new (): HTMLSCntMarketProductAddingMainElement;
    };
    interface HTMLSCntMarketProductAddingSidebarElement extends Components.SCntMarketProductAddingSidebar, HTMLStencilElement {
    }
    var HTMLSCntMarketProductAddingSidebarElement: {
        prototype: HTMLSCntMarketProductAddingSidebarElement;
        new (): HTMLSCntMarketProductAddingSidebarElement;
    };
    ...
    interface HTMLSCntMarketProductsListAdminElement extends Components.SCntMarketProductsListAdmin, HTMLStencilElement {
    }
    var HTMLSCntMarketProductsListAdminElement: {
        prototype: HTMLSCntMarketProductsListAdminElement;
        new (): HTMLSCntMarketProductsListAdminElement;
    };
    ...
    interface HTMLSCntMarketProductsListWrapperElement extends Components.SCntMarketProductsListWrapper, HTMLStencilElement {
    }
    var HTMLSCntMarketProductsListWrapperElement: {
        prototype: HTMLSCntMarketProductsListWrapperElement;
        new (): HTMLSCntMarketProductsListWrapperElement;
    };
    ...
    interface HTMLSCntMarketTextRedactorBoxElement extends Components.SCntMarketTextRedactorBox, HTMLStencilElement {
    }
    var HTMLSCntMarketTextRedactorBoxElement: {
        prototype: HTMLSCntMarketTextRedactorBoxElement;
        new (): HTMLSCntMarketTextRedactorBoxElement;
    };
    interface HTMLSCntMarketToolbarAddRootCategoryElement extends Components.SCntMarketToolbarAddRootCategory, HTMLStencilElement {
    }
    var HTMLSCntMarketToolbarAddRootCategoryElement: {
        prototype: HTMLSCntMarketToolbarAddRootCategoryElement;
        new (): HTMLSCntMarketToolbarAddRootCategoryElement;
    };
    interface HTMLSCntMarketToolbarCategoryEditorElement extends Components.SCntMarketToolbarCategoryEditor, HTMLStencilElement {
    }
    var HTMLSCntMarketToolbarCategoryEditorElement: {
        prototype: HTMLSCntMarketToolbarCategoryEditorElement;
        new (): HTMLSCntMarketToolbarCategoryEditorElement;
    };
    interface HTMLSCntMarketToolbarCategoryFooterElement extends Components.SCntMarketToolbarCategoryFooter, HTMLStencilElement {
    }
    var HTMLSCntMarketToolbarCategoryFooterElement: {
        prototype: HTMLSCntMarketToolbarCategoryFooterElement;
        new (): HTMLSCntMarketToolbarCategoryFooterElement;
    };
    interface HTMLSCntMarketToolbarCategoryModalPreviewWindowElement extends Components.SCntMarketToolbarCategoryModalPreviewWindow, HTMLStencilElement {
    }
    var HTMLSCntMarketToolbarCategoryModalPreviewWindowElement: {
        prototype: HTMLSCntMarketToolbarCategoryModalPreviewWindowElement;
        new (): HTMLSCntMarketToolbarCategoryModalPreviewWindowElement;
    };
    interface HTMLSCntMarketToolbarCategorySidebarElement extends Components.SCntMarketToolbarCategorySidebar, HTMLStencilElement {
    }
    var HTMLSCntMarketToolbarCategorySidebarElement: {
        prototype: HTMLSCntMarketToolbarCategorySidebarElement;
        new (): HTMLSCntMarketToolbarCategorySidebarElement;
    };
    interface HTMLSCntMarketToolbarProductsCategoryListElement extends Components.SCntMarketToolbarProductsCategoryList, HTMLStencilElement {
    }
    var HTMLSCntMarketToolbarProductsCategoryListElement: {
        prototype: HTMLSCntMarketToolbarProductsCategoryListElement;
        new (): HTMLSCntMarketToolbarProductsCategoryListElement;
    };
    interface HTMLSCntMarketToolbarProductsInCategoryElement extends Components.SCntMarketToolbarProductsInCategory, HTMLStencilElement {
    }
    var HTMLSCntMarketToolbarProductsInCategoryElement: {
        prototype: HTMLSCntMarketToolbarProductsInCategoryElement;
        new (): HTMLSCntMarketToolbarProductsInCategoryElement;
    };
    interface HTMLSCntMarketToolbarProductsInCategoryFooterElement extends Components.SCntMarketToolbarProductsInCategoryFooter, HTMLStencilElement {
    }
    var HTMLSCntMarketToolbarProductsInCategoryFooterElement: {
        prototype: HTMLSCntMarketToolbarProductsInCategoryFooterElement;
        new (): HTMLSCntMarketToolbarProductsInCategoryFooterElement;
    };
    ...
    interface HTMLElementTagNameMap {
        ...
        "s-cnt-market-admin-toolbar-category": HTMLSCntMarketAdminToolbarCategoryElement;
        "s-cnt-market-admin-toolbar-head-btn": HTMLSCntMarketAdminToolbarHeadBtnElement;
        ...
        "s-cnt-market-cart-products": HTMLSCntMarketCartProductsElement;
        "s-cnt-market-category-editor-home-page": HTMLSCntMarketCategoryEditorHomePageElement;
        ...
        "s-cnt-market-empty-cart": HTMLSCntMarketEmptyCartElement;
        ...
        "s-cnt-market-ordering-modal-window": HTMLSCntMarketOrderingModalWindowElement;
        ...
        "s-cnt-market-ordering-sidebar-dropdown": HTMLSCntMarketOrderingSidebarDropdownElement;
        "s-cnt-market-ordering-sidebar-promo-code": HTMLSCntMarketOrderingSidebarPromoCodeElement;
        ...
        "s-cnt-market-product-adding": HTMLSCntMarketProductAddingElement;
        "s-cnt-market-product-adding-attributes": HTMLSCntMarketProductAddingAttributesElement;
        "s-cnt-market-product-adding-main": HTMLSCntMarketProductAddingMainElement;
        "s-cnt-market-product-adding-sidebar": HTMLSCntMarketProductAddingSidebarElement;
        ...
        "s-cnt-market-products-list-admin": HTMLSCntMarketProductsListAdminElement;
        ...
        "s-cnt-market-products-list-wrapper": HTMLSCntMarketProductsListWrapperElement;
        ...
        "s-cnt-market-text-redactor-box": HTMLSCntMarketTextRedactorBoxElement;
        "s-cnt-market-toolbar-add-root-category": HTMLSCntMarketToolbarAddRootCategoryElement;
        "s-cnt-market-toolbar-category-editor": HTMLSCntMarketToolbarCategoryEditorElement;
        "s-cnt-market-toolbar-category-footer": HTMLSCntMarketToolbarCategoryFooterElement;
        "s-cnt-market-toolbar-category-modal-preview-window": HTMLSCntMarketToolbarCategoryModalPreviewWindowElement;
        "s-cnt-market-toolbar-category-sidebar": HTMLSCntMarketToolbarCategorySidebarElement;
        "s-cnt-market-toolbar-products-category-list": HTMLSCntMarketToolbarProductsCategoryListElement;
        "s-cnt-market-toolbar-products-in-category": HTMLSCntMarketToolbarProductsInCategoryElement;
        "s-cnt-market-toolbar-products-in-category-footer": HTMLSCntMarketToolbarProductsInCategoryFooterElement;
...
declare namespace LocalJSX {
    ...
    interface SCntMarketAdminToolbarHeadBtn {
        "onSelectedTab"?: (event: CustomEvent<any>) => void;
        "toolbarHead"?: AdminToolbarHeadBtnInterface;
    }
    interface SCntMarketApp {
        /**
    ...
    interface SCntMarketCartProducts {
         ...
         */
        "MarketCartProductsState"?: MarketCartProductsInterface[];
        "onClickOnByProducts"?: (event: CustomEvent<void>) => void;
        /**
          * /Закрыть корзину
         */
        "onCloseBasket"?: (event: CustomEvent<void>) => void;
    ...
    interface SCntMarketHeaderNav {
        ...
        "login"?: boolean;
        "navBar"?: MarketNavBarInterface;
        "onClickOnByProducts"?: (event: CustomEvent<any>) => void;
        "onClickOnOrders"?: (event: CustomEvent<any>) => void;
        "onClickOnWishlist"?: (event: CustomEvent<any>) => void;
        "onOpenLoginModal"?: (event: CustomEvent<any>) => void;
        /**
          * магазины для вашего города
         */
    ...
    interface SCntMarketHeaderWrapper {
         ...
         */
        "login"?: boolean;
        "onClickOnLogo"?: (event: CustomEvent<void>) => void;
    ...
    interface SCntMarketItemSelection {
         ...
         */
        "forSelection"?: MarketSelectionInterface;
        "onClickOnSelection"?: (event: CustomEvent<any>) => void;
    }
    interface SCntMarketItemSpecialist {
        /**
          * Данные для компонента Specialist
    ...
    interface SCntMarketOrderingModalWindow {
         ...
         */
        "onClickOnCloseBtn"?: (event: CustomEvent<any>) => void;
        /**
          * Данные для модалки
         */
        "orderingModal"?: any;
    ...
    interface SCntMarketOrderingPaymentOnline {
         ...
         */
        "onAddClassInvalid"?: (event: CustomEvent<any>) => void;
        /**
          * Удаление класса active
         */
        "onRemoveClassActive"?: (event: CustomEvent<any>) => void;
         ...
         */
        "onRemoveClassInvalid"?: (event: CustomEvent<any>) => void;
        /**
          * Данные для модалки
         */
        "orderingModals"?: any;
    ...
    interface SCntMarketOrderingReplacementPolicy {
        ...
        /**
          * Клик по панели
         */
        "onClickOnPanel"?: (event: CustomEvent<any>) => void;
        /**
          * Данные для панелей политика доставки
         */
        "panels"?: MarketOrderingPanelsInterface;
    ...
    interface SCntMarketOrderingTimePanelItem {
         ...
         */
        "onClickOnItem"?: (event: CustomEvent<any>) => void;
        /**
          * Время заказа
         */
        "time"?: MarketOrderingTimetableTimeInterface;
    ...
    interface SCntMarketProductAdding {
         ...
         */
        "onClickOnBackProductList"?: (event: CustomEvent<void>) => void;
    }
    interface SCntMarketProductAddingAttributes {
    }
    interface SCntMarketProductAddingMain {
    ...
    interface SCntMarketProductsListAdmin {
         ...
         */
        "onClickOnAddNewProduct"?: (event: CustomEvent<void>) => void;
    }
    interface SCntMarketProductsListCard {
        /**
          * Клик
    ...
    interface IntrinsicElements {
        ...
        "s-cnt-market-admin-toolbar-category": SCntMarketAdminToolbarCategory;
        "s-cnt-market-admin-toolbar-head-btn": SCntMarketAdminToolbarHeadBtn;
        "s-cnt-market-app": SCntMarketApp;
        "s-cnt-market-back-to-top": SCntMarketBackToTop;
        "s-cnt-market-basket": SCntMarketBasket;
        "s-cnt-market-cart-products": SCntMarketCartProducts;
        "s-cnt-market-category-editor-home-page": SCntMarketCategoryEditorHomePage;
        ...
        "s-cnt-market-empty-cart": SCntMarketEmptyCart;
        ...
        "s-cnt-market-ordering-modal-window": SCntMarketOrderingModalWindow;
        ...
        "s-cnt-market-ordering-sidebar-dropdown": SCntMarketOrderingSidebarDropdown;
        "s-cnt-market-ordering-sidebar-promo-code": SCntMarketOrderingSidebarPromoCode;
        ...
        "s-cnt-market-product-adding": SCntMarketProductAdding;
        "s-cnt-market-product-adding-attributes": SCntMarketProductAddingAttributes;
        "s-cnt-market-product-adding-main": SCntMarketProductAddingMain;
        "s-cnt-market-product-adding-sidebar": SCntMarketProductAddingSidebar;
        ...
        "s-cnt-market-products-list-admin": SCntMarketProductsListAdmin;
        "s-cnt-market-products-list-card": SCntMarketProductsListCard;
        "s-cnt-market-products-list-item": SCntMarketProductsListItem;
        "s-cnt-market-products-list-wrapper": SCntMarketProductsListWrapper;
        ...
        "s-cnt-market-text-redactor-box": SCntMarketTextRedactorBox;
        "s-cnt-market-toolbar-add-root-category": SCntMarketToolbarAddRootCategory;
        "s-cnt-market-toolbar-category-editor": SCntMarketToolbarCategoryEditor;
        "s-cnt-market-toolbar-category-footer": SCntMarketToolbarCategoryFooter;
        "s-cnt-market-toolbar-category-modal-preview-window": SCntMarketToolbarCategoryModalPreviewWindow;
        "s-cnt-market-toolbar-category-sidebar": SCntMarketToolbarCategorySidebar;
        "s-cnt-market-toolbar-products-category-list": SCntMarketToolbarProductsCategoryList;
        "s-cnt-market-toolbar-products-in-category": SCntMarketToolbarProductsInCategory;
        "s-cnt-market-toolbar-products-in-category-footer": SCntMarketToolbarProductsInCategoryFooter;
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            ...
            "s-cnt-market-admin-toolbar-category": LocalJSX.SCntMarketAdminToolbarCategory & JSXBase.HTMLAttributes<HTMLSCntMarketAdminToolbarCategoryElement>;
            "s-cnt-market-admin-toolbar-head-btn": LocalJSX.SCntMarketAdminToolbarHeadBtn & JSXBase.HTMLAttributes<HTMLSCntMarketAdminToolbarHeadBtnElement>;
            ...
            "s-cnt-market-cart-products": LocalJSX.SCntMarketCartProducts & JSXBase.HTMLAttributes<HTMLSCntMarketCartProductsElement>;
            "s-cnt-market-category-editor-home-page": LocalJSX.SCntMarketCategoryEditorHomePage & JSXBase.HTMLAttributes<HTMLSCntMarketCategoryEditorHomePageElement>;
            ...
            "s-cnt-market-empty-cart": LocalJSX.SCntMarketEmptyCart & JSXBase.HTMLAttributes<HTMLSCntMarketEmptyCartElement>;
            ...
            "s-cnt-market-ordering-modal-window": LocalJSX.SCntMarketOrderingModalWindow & JSXBase.HTMLAttributes<HTMLSCntMarketOrderingModalWindowElement>;
            ...
            "s-cnt-market-ordering-sidebar-dropdown": LocalJSX.SCntMarketOrderingSidebarDropdown & JSXBase.HTMLAttributes<HTMLSCntMarketOrderingSidebarDropdownElement>;
            "s-cnt-market-ordering-sidebar-promo-code": LocalJSX.SCntMarketOrderingSidebarPromoCode & JSXBase.HTMLAttributes<HTMLSCntMarketOrderingSidebarPromoCodeElement>;
            ...
            "s-cnt-market-product-adding": LocalJSX.SCntMarketProductAdding & JSXBase.HTMLAttributes<HTMLSCntMarketProductAddingElement>;
            "s-cnt-market-product-adding-attributes": LocalJSX.SCntMarketProductAddingAttributes & JSXBase.HTMLAttributes<HTMLSCntMarketProductAddingAttributesElement>;
            "s-cnt-market-product-adding-main": LocalJSX.SCntMarketProductAddingMain & JSXBase.HTMLAttributes<HTMLSCntMarketProductAddingMainElement>;
            "s-cnt-market-product-adding-sidebar": LocalJSX.SCntMarketProductAddingSidebar & JSXBase.HTMLAttributes<HTMLSCntMarketProductAddingSidebarElement>;
            ...
            "s-cnt-market-products-list-admin": LocalJSX.SCntMarketProductsListAdmin & JSXBase.HTMLAttributes<HTMLSCntMarketProductsListAdminElement>;
            ...
            "s-cnt-market-products-list-wrapper": LocalJSX.SCntMarketProductsListWrapper & JSXBase.HTMLAttributes<HTMLSCntMarketProductsListWrapperElement>;
            ...
            "s-cnt-market-text-redactor-box": LocalJSX.SCntMarketTextRedactorBox & JSXBase.HTMLAttributes<HTMLSCntMarketTextRedactorBoxElement>;
            "s-cnt-market-toolbar-add-root-category": LocalJSX.SCntMarketToolbarAddRootCategory & JSXBase.HTMLAttributes<HTMLSCntMarketToolbarAddRootCategoryElement>;
            "s-cnt-market-toolbar-category-editor": LocalJSX.SCntMarketToolbarCategoryEditor & JSXBase.HTMLAttributes<HTMLSCntMarketToolbarCategoryEditorElement>;
            "s-cnt-market-toolbar-category-footer": LocalJSX.SCntMarketToolbarCategoryFooter & JSXBase.HTMLAttributes<HTMLSCntMarketToolbarCategoryFooterElement>;
            "s-cnt-market-toolbar-category-modal-preview-window": LocalJSX.SCntMarketToolbarCategoryModalPreviewWindow & JSXBase.HTMLAttributes<HTMLSCntMarketToolbarCategoryModalPreviewWindowElement>;
            "s-cnt-market-toolbar-category-sidebar": LocalJSX.SCntMarketToolbarCategorySidebar & JSXBase.HTMLAttributes<HTMLSCntMarketToolbarCategorySidebarElement>;
            "s-cnt-market-toolbar-products-category-list": LocalJSX.SCntMarketToolbarProductsCategoryList & JSXBase.HTMLAttributes<HTMLSCntMarketToolbarProductsCategoryListElement>;
            "s-cnt-market-toolbar-products-in-category": LocalJSX.SCntMarketToolbarProductsInCategory & JSXBase.HTMLAttributes<HTMLSCntMarketToolbarProductsInCategoryElement>;
            "s-cnt-market-toolbar-products-in-category-footer": LocalJSX.SCntMarketToolbarProductsInCategoryFooter & JSXBase.HTMLAttributes<HTMLSCntMarketToolbarProductsInCategoryFooterElement>;
